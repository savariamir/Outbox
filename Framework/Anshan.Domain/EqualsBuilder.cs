...
namespace Anshan.Domain
{
    ...
    public class EqualsBuilder
    {
        ...
        public static bool ReflectionEquals(object lhs,
                                            object rhs)
        {
        ...
        private void EnsureArraysSameDemention(object lhs,
                                               object rhs)
        {
        ...
        private void CompareArrays(object parray1,
                                   object parray2,
                                   int prank,
                                   int pindex)
        {
        ...
        /// <returns> EqualsBuilder - used to chain calls. </returns>
        public EqualsBuilder Append(bool lhs,
                                    bool rhs)
        {
            if (isEqual == false) return this;
            isEqual = lhs == rhs;
